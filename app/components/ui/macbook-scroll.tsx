...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[300vh] lg:min-h-[300vh] w-full flex flex-col items-center py-0 md:pb-40 md:pt-40 mb-96 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-black text-3xl font-bold mb-20 text-center"
      >
        {title || (
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        <div className="absolute inset-0 bg-[#272729] rounded-lg mb-40" />
        <Image
          src={src as string}
          alt="aceternity logo"
          fill
