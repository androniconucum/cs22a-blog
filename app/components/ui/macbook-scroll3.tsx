...
export const MacbookScroll3 = ({
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[300vh] lg:min-h-[400vh] flex flex-col items-center mt-96 py-0 md:py-96 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
